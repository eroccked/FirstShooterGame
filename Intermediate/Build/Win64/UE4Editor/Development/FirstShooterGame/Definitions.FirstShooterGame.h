...
#define UE_PROJECT_NAME FirstShooterGame
#define UE_TARGET_NAME FirstShooterGameEditor
#define UE_MODULE_NAME "FirstShooterGame"
...
#define FIRSTSHOOTERGAME_API DLLEXPORT
